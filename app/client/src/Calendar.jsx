...
function addevent() {
  ...
  // let eventisrepetition = body.eventisrepetition;

  console.log(eventtitle, eventdate, eventtime, eventdescription, eventisrepetition);
  let data = { 'eventtitle': eventtitle, 'eventdate': eventdate, 'eventtime': eventtime, 'eventdescription': eventdescription, 'eventisrepetition': eventisrepetition };
